        ...
        <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6 lg:mt-16">
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              <h1>
                <span className="mt-1 block text-4xl tracking-tight font-merriweather sm:text-5xl xl:text-6xl">
                  <span className="block text-gray-900">Browse on Amazon, buy from your local bookstore</span>
                </span>
              </h1>
